...
class TestPart(unittest.TestCase):
    ...
    def test_equivalent_returns_true_for_equivalent_parts(self):
        ...
        self.assertTrue(
            part1.equivalent(part1_equiv),
            "Parts with same attribute values should be equivalent.",
        )
    ...
    def test_equivalent_returns_false_for_non_equivalent_parts(self):
        ...
        self.assertFalse(
            part1.equivalent(part2),
            "Parts with different attribute values should not be equivalent.",
        )
